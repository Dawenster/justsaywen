class WorksController < ApplicationController
  ...
  def show
    ...
    @next_work = client.posts("justsaywen.tumblr.com", :filter => "text", :tag => next_work_section(params[:slug]))["posts"].last
  end

  private

  def next_work(current_work)
    works = ["time-auction", "to-tablets", "flyshortcut", "sola-caritas", "college-pro", "iya", "axiom-zen", "legalreach", "kpmg", "secor", "rl-solutions"]
